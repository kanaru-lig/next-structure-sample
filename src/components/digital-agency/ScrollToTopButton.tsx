...
export const scrollToTopButtonStyle =
  "flex h-14 w-14 items-center justify-center rounded-full border cursor-pointer bg-white border-blue-900 hover:border-blue-1000 hover:bg-blue-200 focus:outline-2 focus:outline-focused focus:outline-offset-4 active:border-blue-1200 active:bg-blue-300";
...
export const ScrollToTopButton = (props: ScrollToTopButtonProps) => {
  ...
  return (
    <a
      ...
      className={`${scrollToTopButtonStyle} ${className ?? ""} group`}
      {...rest}
    >
      <svg
        aria-hidden
