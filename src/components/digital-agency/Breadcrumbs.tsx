...
export const breadcrumbsItemStyle =
  "text-blue-1000 text-oln-14N-1 underline hover:bg-blue-50 hover:rounded-[4px] active:text-blue-1200 focus:outline-2 focus:outline-focused";
