...
export const linkStyle =
  "text-label-lg text-link underline rounded-[4px] visited:text-visited hover:text-hover active:text-active focus:outline-2 focus:outline focus:outline-focused";
    ...
    <a className={`${linkStyle} ${className ?? ""}`} {...rest}>
      ...
      {props.target === "_blank" && (
        <svg
          ...
          className={`${icon ? icon.className ?? "" : ""} mb-1 ml-1 inline`}
          fill="none"
          height="13"
          viewBox="0 0 12 13"
          width="14"
